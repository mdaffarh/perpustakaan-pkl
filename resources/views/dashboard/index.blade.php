                    ...
                    <div class="col-8">
                        <div class="card card-success">
                            <div class="card-header">
                                <h3 class="card-title">Bar Chart Peminjaman</h3>
                            </div>
                            <div class="card-body">
                                <div class="chart">
                    ...
                    <div class="col-4">
                        <div class="card card-danger">
                            ...
                            <div class="card-body"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                                <canvas id="donutChart" style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%; display: block; width: 397px;" width="794" height="500" class="chartjs-render-monitor"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
