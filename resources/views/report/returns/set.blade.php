@extends('layout.main')
@section('title', "Report Pengembalian Buku")
	...
	<div class="row">
		<div class="col">
			<div class="card card-outline-tabs">
                ...
                <div class="card-body">
                    <form action="/report/returns" method="post">
                        @csrf
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <select name="status" id="" class="select2 form-control">
                                ...
                                @foreach ($status as $stat)
                                    <option value="{{ $stat->dikembalikan }}">{{ $stat->dikembalikan == "Sudah" ? "Selesai" : "Belum dikembalikan" }}</option>
                                @endforeach
                            </select>
                        </div>
