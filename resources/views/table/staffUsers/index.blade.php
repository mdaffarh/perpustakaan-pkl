...
<div class="content-wrapper">
	...
	<div class="card">
		<div class="card-header">
			<h3 class="card-title">Data Staff User</h3>
		</div>
					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body">
								<div class="modal-body">
                                    <form action="/table/staffUsers" method="post" enctype="multipart/form-data">
                                        @csrf
										<div class="form-floating mb-3">
                                            <label for="floatingInput3">Staff ID</label>
                                            <input required name="staff_id" type="number"  required class="form-control" id="floatingInput3">
                                        </div>
                                        <div class="form-floating mb-3">
					...
					<tr>
						...
						<td>
                            ...
                            <div class="modal fade" id="modalEditData{{ $staffUser->id }}">
                            	<div class="modal-dialog">
                            		<div class="modal-content">
                            			...
                            			<div class="modal-body">
                            				<div class="modal-body">
                            					<form action="/table/staffUsers/{{ $staffUser->id }}" method="post" enctype="multipart/form-data">
                            						@method('put')
                            						@csrf
													<div class="form-floating mb-3">
														<label for="floatingInput3">Staff ID</label>
														<input required name="staff_id" type="number"  required class="form-control" id="floatingInput3" value="{{ $staffUser->staff_id }}">
													</div>
													<div class="form-floating mb-3">
														<label for="floatingInput3">Username</label>
                            ...
                            <a href="">
                                ...
                                <form action="/table/staffUsers/{{ $staffUser->id }}" method="POST" class="d-inline">
                                    @method('delete')
                                    @csrf
