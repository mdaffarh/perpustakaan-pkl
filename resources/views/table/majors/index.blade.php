											...
											<div class="modal-body">
												<form action="/table/majors" method="post" enctype="multipart/form-data">
													...
													<div class="form-floating mb-3">
														...
														<input required name="short" type="text" required class="form-control" id="floatingInput3">
													</div>
													<div class="form-floating mb-3">
														<label for="floatingInput3">Nama Lengkap</label>
														<input required name="short" type="text" required class="form-control" id="floatingInput3">
													</div>
						...
						<table id="example1" class="table table-bordered table-striped">
							...
							<tbody>
								...
								<tr>
									...
									<td>{{ $major->full }}</td>
									<td>
										<a href="#modalEditData{{ $major->id }}" data-toggle="modal" class="btn btn-outline-info btn-sm">
										...
										<div class="modal fade" id="modalEditData{{ $major->id }}">
											<div class="modal-dialog modal-lg">
												<div class="modal-content">
													<div class="modal-header">
													...
													<div class="modal-body">
														<div class="modal-body">
															<form action="/table/majors/{{ $major->id }}" method="post" enctype="multipart/form-data">
																...
																<div class="form-floating mb-3">
																	<label for="floatingInput3">Singkatan</label>
																	<input required name="short" type="text" required class="form-control" id="floatingInput3" value="{{ $major->short }}">
																</div>
																<div class="form-floating mb-3">
																	<label for="floatingInput3">Nama lengkap</label>
																	<input required name="full" type="text" required class="form-control" id="floatingInput3" value="{{ $major->full }}">
																</div>
																<div class="input-group">
																	<button class="btn btn-success rounded me-1" type="submit">Submit</button>
																</div>
								...
								{{-- Show --}}
										<a href="#show{{ $major->id }}" data-toggle="modal" class="btn btn-outline-success btn-sm">
										...
										<div class="modal fade" id="show{{ $major->id }}">
											<div class="modal-dialog modal-lg">
												<div class="modal-content">
													<div class="modal-header">
													...
													<div class="modal-body">
														<div class="modal-body">
															<form action="/table/majors/{{ $major->id }}" method="post" enctype="multipart/form-data">
																...
																<div class="form-floating mb-3">
																	<label for="floatingInput3">Singkatan</label>
																	<input required name="short" type="text" required class="form-control" id="floatingInput3" value="{{ $major->short }}" disabled>
																</div>
																<div class="form-floating mb-3">
																	<label for="floatingInput3">Nama Lengkap</label>
																	<input required name="full" type="text" required class="form-control" id="floatingInput3" value="{{ $major->full }}" disabled>
																</div>
															</form>
														</div>
													</div>
