				...
				<div class="card-body">
											...
											<div class="modal-body">
												<form action="/transaction/book-donations" method="post" enctype="multipart/form-data">
													...
													<div class="form-floating mb-3">
														...
														<input required name="isbn" type="text" class="form-control @error('isbn') is-invalid @enderror " id="floatingInput3"  value="{{ old('isbn') }}">
															@error('isbn')
													...
													<div class="form-floating mb-3">
														...
														<input required name="judul" type="text" class="form-control @error('judul') is-invalid @enderror " id="floatingInput3" value="{{ old('judul') }}">
															@error('judul')
																<div class="invalid-feedback">
																	{{ $message }}
																</div>
													...
													<div class="form-floating mb-3">
														...
														<input required name="penulis" type="text" class="form-control @error('penulis') is-invalid @enderror " id="floatingInput3" value="{{ old('penulis') }}" >
															@error('penulis')
																<div class="invalid-feedback">
																	{{ $message }}
																</div>
													...
													<div class="form-floating mb-3">
														...
														<input required name="penerbit" type="text" class="form-control @error('penerbit') is-invalid @enderror " id="floatingInput3" value="{{ old('penerbit') }}" >
															@error('penerbit')
																<div class="invalid-feedback">
																	{{ $message }}
																</div>
													...
													<div class="form-floating mb-3">
														<label for="floatingInput3">Jumlah</label>
														<input required name="jumlah" type="number" required class="form-control @error('jumlah') is-invalid @enderror " id="floatingInput3" value="{{ old('jumlah') }}">
														@error('jumlah')
															<div class="invalid-feedback">
																{{ $message }}
															</div>
													...
													<div class="form-floating mb-3">
														...
														<textarea required name="keterangan" type="text" style="height: 100px" placeholder="Contoh : Buku ini adalah buku bekas" required class="form-control @error('tglMasuk') is-invalid @enderror " id="floatingInput3" value="{{ old('tglMasuk') }}" cols="30" rows="10"></textarea>
														@error('keterangan')
															<div class="invalid-feedback">
																{{ $message }}
															</div>
													...
													<div class="form-floating mb-3">
														...
														<input required name="tglTerbit" type="date"  class="form-control @error('tglTerbit') is-invalid @enderror " id="floatingInput3" value="{{ old('tglTerbit') }}">
														@error('tglTerbit')
															<div class="invalid-feedback">
																{{ $message }}
															</div>
													...
													<div class="form-floating mb-3">
														...
														<input required name="tglMasuk" type="date" class="form-control @error('tglMasuk') is-invalid @enderror " id="floatingInput3" value="{{ old('tglMasuk') }}">
														@error('tglMasuk')
															<div class="invalid-feedback">
																{{ $message }}
															</div>
					...
					@can('member')
						...
						<table id="example2" class="table table-bordered table-striped">
							...
							<tbody>
								@foreach($bookDonated as $bookDonation)
								<tr>
									<td>{{ $loop->iteration }}</td>
									<td>{{ $bookDonation->isbn }}</td>
									<td>{{ $bookDonation->judul }}</td>
													...
													<div class="modal-body">
														<div class="modal-body">
															<form action="/transaction/book-donations/{{ $bookDonation->id }}" method="post" enctype="multipart/form-data">
																...
																<div class="form-floating mb-3">
																	<label for="floatingInput3">Kategori</label>
																	<input type="text" class="form-control" name="" id="" value="{{ $bookDonation->kategori }}" disabled>
																</div>
																<div class="form-floating mb-3">
																	<label for="floatingInput3">Tanggal Terbit</label>
																	<input required name="tglTerbit" type="date" required class="form-control" id="floatingInput3" value="{{ $bookDonation->tglTerbit }}" disabled>
