					...
					<div class="tab-content" id="custom-tabs-two-tabContent">
														...
														<div class="modal-footer">
															...
															<form action="/transaction/member-registrations/approved/{member-id}" method="post" enctype="multipart/form-data">
																...
																<div style="display: none;">
																	...
																	<input type="text" name="jenis_kelamin" id="" value="{{ $member->jenis_kelamin }}">
						...
						<div class="tab-pane fade" id="tabs-accepted" role="tabpanel" aria-labelledby="tabs-accepted-tab">
							<table id="example1" class="table table-bordered table-striped">
								...
								<tbody>
									@foreach($memberAccepted as $member)
									<tr>
										<td>{{ $loop->iteration }}</td>
										<td>{{ $member->nama }}</td>
										<td>{{ $member->kelas }}</td>
						...
						<div class="tab-pane fade" id="tabs-rejected" role="tabpanel" aria-labelledby="tabs-rejected-tab">
							<table id="example1" class="table table-bordered table-striped">
								...
								<tbody>
									@foreach($memberRejected as $member)
									<tr>
										<td>{{ $loop->iteration }}</td>
										<td>{{ $member->nama }}</td>
										<td>{{ $member->kelas }}</td>
														...
														<div class="modal-body">
															<div class="modal-body">
																<form action="/table/memberRegistration/{{ $member->id }}" method="post" enctype="multipart/form-data">
																	...
																	@if ($member->created_by)
																		<div class="form-floating mb-3">
																			<label for="floatingInput3">Ditolak pada {{ $member->created_at }} oleh {{ $member->creator->nama }}</label>
																		</div>
																	@endif
