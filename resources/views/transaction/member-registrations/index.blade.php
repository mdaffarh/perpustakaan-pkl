							...
							<tr>
								...
								<td>
									...
									<div class="btn-group btn-group-sm" role="group" aria-label="Small button group">
										...
										{{-- TERIMA --}}
										<button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modal-default{{ $member->id }}" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Jadikan Anggota"><i class="fas fa-check"></i> </button>
